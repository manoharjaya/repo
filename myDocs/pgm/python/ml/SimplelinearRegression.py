...
def train_test_split(dataset, split):
	...
	return train, dataset_copy    # train data is 39 and test data is 25 ie. 60 ratio on training data
...
for i in range(len(dataset[0])):   # ['x','y']
